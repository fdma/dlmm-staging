...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'birdeyedotso/1.0.0 (api/6.1.3)');
  }
  ...
  /**
   * Get OHLCV price of a pair. Maximum 1000 records returned.
   *
   * @summary OHLCV - Pair
  ...
  /**
   * This endpoint will be discontinued on March 23, 2025. Please use token list v3 and token
   * list v3 scroll instead.
   *
  ...
  /**
   * Get metadata of multiple tokens. Maximum 50 addresses.
   *
  ...
  /**
   * Get overview of multiple pairs. Maximum 20 addresses.
   *
  ...
  /**
   * Get market data of multiple tokens. Maximum 20 addresses.
   *
   * @summary Token - Market Data (Multiple)
   * @throws FetchError<400, types.GetDefiV3TokenMarketDataMultipleResponse400> Bad Request
   * @throws FetchError<401, types.GetDefiV3TokenMarketDataMultipleResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TokenMarketDataMultipleResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TokenMarketDataMultipleResponse429> Too Many Requests
  ...
  /**
   * Get trade data of multiple tokens. Maximum 20 addresses.
   *
  ...
  /**
   * Fetching up to 5000 tokens per batch.<br>In the initial request, you can apply all
   * filter parameters (DONOT include scroll_id).<br>From the secondary request, only include
   * the scroll_id parameter which using the next_scroll_id value returned from your previous
   * request.<br>Maximum 1 scroll_id / account / 1 minute
   *
   * @summary Token - List (V3) Scroll
   * @throws FetchError<400, types.GetDefiV3TokenListScrollResponse400> Bad Request
   * @throws FetchError<401, types.GetDefiV3TokenListScrollResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TokenListScrollResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TokenListScrollResponse429> Too Many Requests
  ...
  /**
   * Get token list of given chain
   *
   * @summary Token - List (V3)
   * @throws FetchError<400, types.GetDefiV3TokenListResponse400> Bad Request
   * @throws FetchError<401, types.GetDefiV3TokenListResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TokenListResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TokenListResponse429> Too Many Requests
   ...
   * @throws FetchError<401, types.GetDefiV3TxsResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TxsResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TxsResponse429> Too Many Requests
  ...
  /**
   * Get list of trades of a token
   *
   * @summary Trades - Token (V3)
   * @throws FetchError<400, types.GetDefiV3TokenTxsResponse400> Bad Request
   * @throws FetchError<401, types.GetDefiV3TokenTxsResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TokenTxsResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TokenTxsResponse429> Too Many Requests
  ...
  /**
   * Get latest block number of a chain
   *
   * @summary Trades - Latest Block Number
   * @throws FetchError<400, types.GetDefiV3TxsLatestBlockResponse400> Bad Request
   * @throws FetchError<401, types.GetDefiV3TxsLatestBlockResponse401> Unauthorized
   * @throws FetchError<403, types.GetDefiV3TxsLatestBlockResponse403> Forbidden
   * @throws FetchError<429, types.GetDefiV3TxsLatestBlockResponse429> Too Many Requests
